...
def delete_task():
    try:
       task_index = listbox_tasks.curselection()[0] #current task selected
       listbox_tasks.delete(task_index)
    except:
        tkinter.messagebox.showwarning(title="Warning!!", message="You must SELECT TASK")

def load_task():
    try:
        tasks = pickle.load(open("tasks.dat","rb"))  # reading binary
...
def save_task():
   ...
   # print(tasks) gives tuple wb-write binary
